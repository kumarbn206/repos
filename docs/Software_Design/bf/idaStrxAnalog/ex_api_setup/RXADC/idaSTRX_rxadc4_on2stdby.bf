...
RXADC4.LF_LDO_CTL.LDO_EN_LF_I=0;  // Disable loop filter LDO, I ADC - analog pin = en_ldo_LF_i
RXADC4.LF_LDO_CTL.LDO_EN_LF_Q=0;  // Disable loop filter LDO, Q ADC - analog pin = en_ldo_LF_q
RXADC4.DAC_SHLDO_CTL.LDO_EN_I=0;  // Disable DAC shunt LDO, I ADC - analog pin = en_ldo_DAC_i
RXADC4.DAC_SHLDO_CTL.LDO_EN_Q=0;  // Disable DAC shunt LDO, Q ADC - analog pin = en_ldo_DAC_q
