function memoryDump = importfileFromInput(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   MEMORYDUMPSINWAVE = IMPORTFILE(FILENAME)
%   Reads data from text file FILENAME for the default selection.
%
%   MEMORYDUMPSINWAVE = IMPORTFILE(FILENAME, STARTROW, ENDROW)
%   Reads data from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   memoryDumpSinWave = importfile('memoryDumpSinWave.txt', 1, 32);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2022/04/14 08:38:22
