...
currentSystemSetting.samples=1024;
currentSystemSetting.CHIRPS=256;
currentSystemSetting.Tacq=25.6;
currentSystemSetting.numRX=4;
currentSystemSetting.Deci=1;
currentSystemSetting.ChirpCF=76.45e9;
currentSystemSetting.sampleFreq=40e6;
currentSystemSetting.Freq_BW=810e6;
currentSystemSetting.Tchirp=33.66;
currentSystemSetting.chirpdirection=-1;
currentSystemSetting.chirpBW=810e6;
...
InputStruct.config_filename='C:\STRX\RFE_FW\SAF85xx_RFE_SW_0_8_10_RC6\SAF85xx_RFE_SW\rfe\tools\rfeConfigGenerator\release\rfeConfig_MR_chirp.bin';
