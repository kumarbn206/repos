...
% checks the relevant api and plots targets. if phase rotation is applieds
% then checks for difference in set and get chirp to chirp phase rotation
power_cycle_molex

Proxy_loc='C:\rfeProxy_0_5_20\bin';%%%%%%%%%%%0.8.9: updated proxy
% Proxy_loc='C:\RFEProxy_V0_5_18\bin';%%%%%%%%%%%0.8.8: proxy
% elfFileLoc='C:\RFEProxy_V0_5_18\bin\rfem7_images\rfeSysValFw\bin';
% elfFileName='rfeSysValFw_hw101_validhw_armgcc';
elfFileLoc='D:\RFE_firmware\28_07_2022';
elfFileName='rfeFw_hw101_release_armclang_moveTxTransEnableAfterBufferCalib';
% elfFileName='rfeFw_hw101_release_armclang_final_test_HF_0_8_9';
% elfFileName='rfeFw_hw101_release_armclang_HF_0_8_9';
% elfFileName='rfeFw_hw101_release_armclang_obwfix_nopr_0_8_9';
Config_loc='C:\rfeConfigGenerator_don\rfeConfigGenerator\release';  %%%%%0.8.9 config location 
% Config_loc='C:\SAF85xx_RFE_SW_EAR_0_8_8_D220624\rfe\tools\rfeConfigGenerator\release\P2';  %%%%%0.8.8 config location 
...
CODE_DATA_FILE_Path='D:\RFE_firmware\SAF85xx_RFE_SW_CD_0_8_7_D220610\SAF85xx_RFE_SW_CD_0_8_7_D220610\rfe\rfeFw\bin';
% CODE_DATA_FILE_Path='C:\STRX\SAF85xx_RFE_SW_EAR_0_8_8_D220624_RC2\SAF85xx_RFE_SW_EAR_0_8_8_D220624\rfe\rfeFw\bin';
...
% for ii= -5:1:15
  ...
  pause(1)
%     power_cycle;
%   CONFIG_filename='C:\SAF85xx_RFE_SW_EAR_0_8_8_D220624\rfe\tools\rfeConfigGenerator\release\rfeConfig.bin';

  CONFIG_filename=[Config_loc,'\rfeConfig.bin'];
  dynamic_filename=[Config_loc,'\rfeDynamicTables.bin'];
% dynamic_filename='';

%   dynamic_filename='C:\SAF85xx_RFE_SW_EAR_0_8_8_D220624\rfe\tools\rfeConfigGenerator\release\rfeDynamicTables.bin';
%   CONFIG_filename='D:\SAF85xx_RFE_SW_BN_030622_071251_1292\SAF85xx_RFE_SW\rfe\tools\rfeConfigGenerator\release\rfeConfig.bin';
% %     CONFIG_filename=strcat('D:\SAF85xx_RFE_SW_BN_030622_071251_1292\SAF85xx_RFE_SW\rfe\tools\rfeConfigGenerator\release\rfeConfig.bin');
...
%     end
    ...
    ll.select(1)
    ll.writeSpi('GLDO.GLD_HLD_PROG.PROG_OUT_GLD1V45',0x3)
...
%     end
    ...
    %% rfe_configure
    [ error ] = rfeabstract.rfe_configure(CONFIG_filename, dynamic_filename);
    if (~error)
        disp('RFE Configured');
    else
        return
